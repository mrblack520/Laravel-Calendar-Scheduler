resources/views/dashboard/employee/user_dashboard.blade.php@extends("layouts.layout")
...
if (inputElement.value.trim() === '') {
    // Input value is empty, so you can show an error
    // For example, you can add a CSS class to style the error
    inputElement.classList.add('error');
} else {
    // Input value is not empty, so you can remove the error class (if it was previously added)
